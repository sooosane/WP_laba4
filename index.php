            ...
            <div class="plants_container">
              <?php foreach($products->product as $product) { ?>
                <div class="plants_card">
                  <a href="update.php?id=<?php echo $product['id']; ?>" class="plants_name">
                    edit
                  </a>
                  <a href="delete.php?id=<?php echo $product['id']; ?>" class="plants_name">
                    delete
                  </a>
                    <a href="#" class="plants_card_link">
                        <div class="plants_img"><img src="<?php echo $product->image; ?>" alt=""></div>
                        <div class="plants_info">
                          <p></p>
                            <h3 class="plants_name"><?php echo $product->name; ?></h3>
                            <p class="plants_price"><?php echo $product->price; ?> $</p>
                        </div>
                    </a>
                </div>
                <?php } ?>
